...
check(read("app/api/enquiries/route.js").includes("This is an automatic receipt") && read("app/api/enquiries/route.js").includes("Maryangel Ajuzieogu"), "Automated receipt clearly distinguishes itself from Maryangel's personal response");
