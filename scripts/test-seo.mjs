...
check(stillness?.intro.startsWith("Eight wilderness journeys") && journeys.filter((journey) => journey.arc === "stillness").length === 8, "Stillness Collection introduction matches its eight journeys");
...
check(journeys.filter((journey) => journey.arc === "disconnected").length === 2 && read("app/journeys/JourneysExperience.jsx").includes('journey.arc === "disconnected"') && !read("app/journeys/[slug]/JourneyPlanning.jsx").includes('"calving-season"') && !read("app/journeys/[slug]/JourneyPlanning.jsx").includes('"calving-isolation"'), "Both calving journeys appear only in the Disconnected catalogue and not Stillness alternatives");
