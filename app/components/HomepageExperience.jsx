...
const arcs = {
  ...
  disconnected: { label: "Disconnected, The Return", name: <>The <em>Return</em></>, desc: "Your arc begins with surrender. Device surrender at check-in. No schedule. The silence that only comes when you have genuinely stopped. We design for the quiet, not around it.", url: "/journeys/dc6" },
...
const journeys = [
  ...
  { href: "/journeys/dc6", image: "https://images.unsplash.com/photo-1547471080-7cc2caa01a7e?w=900&q=80", arcClass: "arc-di", arc: "Disconnected, The Return", nights: "6 nights", name: "The Calving Season", desc: "A lodge landing, the calving grounds, and a deliberate return through the crater.", tags: ["Southern Serengeti", "Ngorongoro"], includes: "Luxury camps, all meals, private transfers, 24/7 curator", price: "$11,075", unit: "/ person" },
];
...
export default function HomepageExperience() {
  return <main className="new-home">
    ...
    <section className="stillness"><div className="stillness-visual"><img src="/images/stillness-collection-forest.jpg" alt="A quiet boat beneath sunlit forest reflected in still water" width="1080" height="1350" loading="lazy" /></div><div className="stillness-right"><span className="kicker">Stillness Collection</span><h2>You did not come here to see more.<br />You came here to need less.</h2><p>These are not safaris measured in sightings. Kimbilio makes you unreachable in Katavi. Kimya gives you back actual quiet on Rubondo Island. The Return holds you in one landscape, while The Deepening uses two — the first unravels, the second holds.</p><div className="stillness-cards"><Link className="stillness-card" href="/journeys/kimbilio"><p className="stillness-dur">4 nights, Katavi National Park</p><p className="stillness-name">Kimbilio</p><p className="stillness-sub">Fly in. Become unreachable. Return on your own terms.</p><span className="stillness-exp">Explore →</span></Link><Link className="stillness-card" href="/journeys/kimya"><p className="stillness-dur">4 nights, Rubondo Island</p><p className="stillness-name">Kimya</p><p className="stillness-sub">An island with no road in. The first silence you have heard in years.</p><span className="stillness-exp">Explore →</span></Link><Link className="stillness-card" href="/journeys/st6"><p className="stillness-dur">6 nights, Grumeti Reserve</p><p className="stillness-name">The Return</p><p className="stillness-sub">One camp. One landscape. One descent into stillness.</p><span className="stillness-exp">Explore →</span></Link><Link className="stillness-card" href="/journeys/st9"><p className="stillness-dur">9 nights, Two landscapes</p><p className="stillness-name">The Deepening</p><p className="stillness-sub">Two camps. Two landscapes. One complete progression.</p><span className="stillness-exp">Explore →</span></Link></div><Link className="stillness-all" href="/journeys/stillness">Explore the Stillness Collection →</Link></div></section>
