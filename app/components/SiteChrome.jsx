    ...
    <>
      ...
      <footer className="site-footer">
        <div className="footer-grid">
          ...
          <div><b>Company</b><Link href="/about">Our philosophy</Link><Link href="/about#curators">The curators</Link><Link href="/the-return">The Return</Link><Link href="/case-studies">Traveller stories</Link><Link href="/sustainability">Sustainability</Link></div>
