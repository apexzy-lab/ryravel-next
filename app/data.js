export const arcs = [
  {
    id: "exhausted",
    label: "Exhausted → Relief",
    title: "The Exhausted Traveller’s Return",
    shortTitle: "Exhausted",
    subtitle: "From exhaustion to relief",
    intro: "Designed for the person who has been running on empty and needs more than a holiday. They need permission to stop.",
    story: "The exhausted traveller is not tired. They are depleted. Tired can be fixed with a week off. Depleted requires a deliberate pace, an environment with no demands, and a sequence that works deeper than entertainment.",
    color: "#d7a252",
    principles: [
  ...
  {
    id: "renewed",
    label: "Renewed · Wellness & Transformation",
    title: "Renewed",
    shortTitle: "Renewed",
    subtitle: "Wellness & Transformation",
    intro: "From a five-night coastal reset to a complete nine-night Ayurvedic programme, each journey follows one rhythm: practice at dawn, treatment at dusk, nothing scheduled between.",
    story: "Renewal goes further than rest. It works with the body’s own systems to release what has been held, restore what has been depleted, and return the traveller to themselves with clarity.",
    color: "#61b985",
    principles: [
      ["The Assessment", "A full Ayurvedic dosha consultation calibrates every treatment that follows."],
      ["The Foundation", "Abhyanga, the foundational warm-oil treatment, opens the programme."],
      ["The Deepening", "Breathwork, Shirodhara, Udvartana and Kati Basti progressively open the system."],
      ["The Integration", "A closing consultation, written protocol and three signatures seal the arc."],
    ],
  },
  {
    id: "romantic",
    label: "Romantic · Zanzibar Collection",
    title: "Romantic",
    shortTitle: "Romantic",
  ...
  {
    id: "adventurous",
    label: "Adventurous · I will know what I am made of",
    title: "Adventurous",
    shortTitle: "Adventurous",
  ...
  {
    id: "social",
    label: "Social · Connected to my people",
    title: "Social",
    shortTitle: "Social",
...
export const journeys = [
  { slug: "ex6", arc: "exhausted", nights: 6, title: "Pure Decompression", destination: "Zanzibar", tagline: "Six nights. Zanzibar. Nothing asked of you.", description: "Six nights of nothing but coast, stillness, and the permission to stop.", tags: ["Beach", "Spa", "Culture"], price: "$14,034", phases: ["Arrive & Exhale", "Stillness Deepens", "Close & Carry"] },
  { slug: "ex9", arc: "exhausted", nights: 9, title: "Beach, Then Wilderness", destination: "Zanzibar · Serengeti", tagline: "The body dissolves before the wild awakens it.", description: "Coast first. The Serengeti second. Two worlds, one complete restoration.", tags: ["Beach", "Safari", "Spa"], price: "$24,116", phases: ["Dissolve", "Awaken", "Integrate"] },
  ...
  { slug: "rn5", arc: "renewed", nights: 5, title: "The Reset", destination: "Zanzibar", tagline: "Five nights. The body remembers.", description: "Ayurveda, baobab rituals and the ocean float you will never forget.", tags: ["Beach yoga", "Ayurveda", "Baobab"], price: "$12,618", phases: ["Arrive & Soften", "The Foundation", "Integrate"] },
  { slug: "rn7", arc: "renewed", nights: 7, title: "The Transformation", destination: "Zanzibar", tagline: "Go deeper. Return clearer.", description: "Deep Ayurveda, a baobab forest at dawn and sound healing.", tags: ["Deep Ayurveda", "Baobab forest", "Sound"], price: "$21,192", phases: ["Arrive & Open", "The Deepening", "The Return"] },
  { slug: "rn9", arc: "renewed", nights: 9, title: "The Full Renewal Arc", destination: "Zanzibar", tagline: "The complete programme.", description: "Panchakarma, Stone Town, the baobab forest and a 30-day return protocol.", tags: ["Panchakarma", "Stone Town", "Baobab"], price: "$24,239", phases: ["Assessment", "Deepening", "Expansion", "Integration"] },
