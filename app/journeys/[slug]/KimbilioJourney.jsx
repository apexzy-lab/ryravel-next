  ...
  return (
    <main className={styles.page}>
      ...
      <section className={styles.investment}>
        ...
        <div className={styles.price}><small>From</small><strong>$5,500</strong><span>/ person sharing</span><p>International flights to Arusha not included. Shared charter flights, four nights full board with drinks at meals, two daily game drives, the Usiku night drive, walking safari, park and concession fees, emergency medical evacuation cover, the Departure Box, and the full Return protocol with two curator check-ins are included.</p><Link href={requestHref}>Begin the conversation →</Link></div>
      </section>
