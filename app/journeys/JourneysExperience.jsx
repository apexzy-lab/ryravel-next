...
const arcProfiles = [
  ...
  { id: "disconnected", feeling: "Disconnected", name: "The Return", territory: "Spiritual homecoming", status: "Launched", copy: "For the person who is present everywhere and connected nowhere. Two calving-season journeys make room to meet life as it is; one adds two nights truly off-grid.", who: "You want to feel present again. You are ready to meet what is real on the calving plains and bring that honesty home." },
