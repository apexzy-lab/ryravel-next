...
export default function JourneysPage() {
  return (
    <main>
      <PageHero kicker="Journeys · Tanzania collection" title="Crafted for the way" emphasis="you want to arrive." copy="Five emotional arcs. Fifteen journeys. Every one begins with a feeling." />
      ...
      <section className="catalogue paper-section" id="all">
        <div className="catalogue-heading"><span className="kicker">Tanzania collection · 5 arcs</span><span>15 journeys · 5 emotional arcs</span></div>
        {arcs.map((arc) => (
