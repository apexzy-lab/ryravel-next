...
export const metadata = buildMetadata({ title: "Bespoke Luxury Journeys Worldwide", description: "Explore Ryravel's launched Exhausted and Disconnected emotional arcs, including four Restoration journeys and the six- and seven-night calving-season journeys. Seven further arcs are open for waitlist interest; Stillness has its own collection.", path: "/journeys" });
