...
export default function sitemap() {
  ...
  return [
    ...staticRoutes.map(([path, changeFrequency, priority]) => ({ url: absoluteUrl(path), lastModified: path === "/transformational-travel" ? new Date("2026-09-25T00:00:00.000Z") : lastModified, changeFrequency, priority })),
